...
wget https://github.com/brokercap/Bifrost/releases/download/v2.4.3-beta/bifrost_v2.4.3-beta_Linux-amd64-bin.tar.gz

tar -zxvf bifrost_v2.4.3-beta_Linux-amd64-bin.tar.gz

cd bifrost_v2.4.3-beta_Linux-amd64-bin/bin && chmod a+x ./Bifrost*
